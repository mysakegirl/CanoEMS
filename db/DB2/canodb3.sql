...
CREATE TABLE `tblparticipants` (
  ...
  `participantCode` varchar(300) NOT NULL,
...
INSERT INTO `tblparticipants` (`participantId`, `eventId`, `participantName`, `participantCode`, `isDeleted`) VALUES
(1, 1, 'ANA', 'EMS10001', b'00'),
(2, 1, 'JERAX', 'EMS10002', b'00'),
(3, 1, 'YATORO', 'EMS10003', b'11'),
(4, 1, 'MIRACLE', 'EMS10004', b'00'),
(5, 1, 'N0TAIL-bigdaddy', 'EMS10005', b'00');

-- --------------------------------------------------------

--
-- Table structure for table `tblparticipantsattendance`
--
...
--
-- Indexes for table `tblparticipantsattendance`
--
